...
export const galleryItems: GalleryItem[] = [
  ...
  },
  {
    ...
    category: 'Students',
    title: 'Yogendra Soni',
    image: 'https://i.ibb.co/60h4ZnkV/IMG-20260718-WA0028.jpg',
    description: 'Five Star Hotel Professional - Transformed his public speaking and communication skills.',
  },
  {
    id: 'g-seenu',
    category: 'Students',
    title: 'Seenu Chaudhari',
    image: 'https://i.ibb.co/0VWZKTvk/IMG-20260717-WA0027.jpg',
    description: 'Accountant at Ministry - Mastered public sector briefing and presentation delivery.',
  },
  {
    id: 'g-binnu',
    category: 'Students',
    title: 'Binnu Singh',
    image: 'https://i.ibb.co/tw40RqS8/IMG-20260717-WA0026.jpg',
    description: 'Chartered Accountant - Learned how to present audit pitches with total leadership confidence.',
  },
  {
    id: 'g-sandeep',
    category: 'Students',
    title: 'Sandeep Singh',
    image: 'https://i.ibb.co/LX3NdbYH/IMG-20260717-WA0024.jpg',
    description: 'Indian Air Force Professional - Polished formal operability oratory standard.',
  },
  {
    id: 'g-anwar',
    category: 'Students',
    title: 'Anwar',
    image: 'https://i.ibb.co/jkN7TvTq/IMG-20260717-WA0025.jpg',
    description: 'Manager in Dubai - Gained dynamic accent neutralization for multi-cultural negotiations.',
  },
  {
    id: 'g-ranjit',
    category: 'Students',
    title: 'Ranjit Singh',
    image: 'https://i.ibb.co/ds3bbZmL/IMG-20260717-WA0022.jpg',
    description: 'IIT Professor - Developed beautiful voice dynamics for massive lecture halls.',
  },
  {
    id: 'g-ranveer',
    category: 'Students',
    title: 'Ranveer Singh',
    image: 'https://i.ibb.co/fG4cJPz3/IMG-20260717-WA0023.jpg',
    description: 'Manager at Private Bank - Gained boardroom self-assurance for HNI portfolio management.',
  },
  {
    id: 'g-preeti',
    category: 'Students',
    title: 'Preeti Singh',
    image: 'https://i.ibb.co/VWBCdDdB/IMG-20260717-WA0020.jpg',
    description: 'Manager in MNC - Cleared language hesitation barrier to speak in global offshore briefings.',
  },
  {
    id: 'g-manoj',
    category: 'Students',
    title: 'Manoj Dubedi',
    image: 'https://i.ibb.co/C39V90Fs/IMG-20260717-WA0021.jpg',
    description: 'SDM (Sub-Divisional Magistrate) - Achieved ultimate public address presence and statecraft speech.',
  },
  {
    id: 'g-sunil',
    category: 'Students',
    title: 'Sunil Saksena',
    image: 'https://i.ibb.co/TBYS991H/IMG-20260717-WA0019.jpg',
    description: 'Officer at Mantralay - Expressed complex policy guidelines seamlessly before committees.',
  },
  {
    id: 'g-devendra',
    category: 'Students',
    title: 'Devendra Singh',
    image: 'https://i.ibb.co/Q7wHJSp7/IMG-20260717-WA0016.jpg',
    description: 'Clerk at High Court - Overcame deep-seated hesitation within weeks of continuous drills.',
  },
  {
    id: 'g-aarti',
    category: 'Students',
    title: 'Aarti Singh',
    image: 'https://i.ibb.co/Gfwr5Dck/IMG-20260717-WA0015.jpg',
    description: 'HR Professional at Infosys - Transformed speech into a commanding corporate town hall presentation voice.',
  },
  {
    id: 'g-manglam',
    category: 'Students',
    title: 'Manglam Singh',
    image: 'https://i.ibb.co/bgkLNG2q/IMG-20260717-WA0014.jpg',
    description: 'Professor - Enhanced lecture-delivery with interactive, engaging storytelling keys.',
  },
  {
    id: 'g-wasim',
    category: 'Students',
    title: 'Wasim',
    image: 'https://i.ibb.co/7t8wKNHD/IMG-20260717-WA0013.jpg',
    description: 'IIT Manager - Handled coordination smoothly and broke public speaking fear.',
  },
  {
    id: 'g-mayank',
    category: 'Students',
